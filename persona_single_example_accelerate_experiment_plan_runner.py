...
from persona_experiments.experiments.persona_single_example_accelerate_experiment import PersonaSingleExampleAccelerateExperiment
...
def main():
    ...
    experiment = PersonaSingleExampleAccelerateExperiment()
